...
clf1 = MLPClassifier(solver='sgd',hidden_layer_sizes=(60, 30), random_state=1, learning_rate='adaptive', learning_rate_init=0.01, max_iter=1000)
clf2 = SVC(probability=True,max_iter=250)
...
f1 = open("similar1MLPSVM", "w+")
f1.write(str(si_1))
f1.close()
f2 = open("similar2MLPSVM", "w+")
f2.write(str(si_2))
f2.close()
